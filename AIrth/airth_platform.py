    ...
    def prepare_training_data(self, data_centers: List[DataCenterModel], 
        ...
        for dc in data_centers:
            for year in range(years):
                # Features: power, area, renewable%, year, temperature increase
                ...
                # Target: future emissions with growth factor
...
class SustainabilityRecommender:
    ...
    def analyze_and_recommend(dc: DataCenterModel, 
        ...
        # 3. Energy Efficiency
        if dc.power_mw > 100:  # Large data center
...
class AIrthPlatform:
    ...
    def generate_summary_dashboard(self):
        ...
        # 2. Emissions vs Renewable Energy
        ax2 = axes[0, 1]
...
def demo_airth_platform():
    ...
    # Add sample data centers (based on real-world examples)
    ...
    # Generate emissions forecast for largest data center
